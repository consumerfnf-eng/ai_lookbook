...
클릭해서 고르거나, 바탕화면·탐색기에서 사진을 **끌어다 놓으면** 돼요. 끌고 있는 동안 놓을 수 있는 칸이 점선으로 표시돼요.

- 룩 카드 영역: 여러 장을 한 번에 놓으면 종류를 한 번만 고르고 모두 추가돼요.
- 카테고리 대표 사진, 메인 히어로·트리오
- 가먼트 보드: 착장샷·제품샷·AI용 제품 사진 칸은 한 장씩 들어가요. 행 제목 쪽에 여러 장을 놓으면 빈 칸부터 채우고, 모자라면 칸을 추가해요.
